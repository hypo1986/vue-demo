...
const router = [
  ...
  {
    name: 'evaluationenter',
    path: '/evaluationenter',
    meta: {
      title: '智能测评'
    },
    component: (resolve) => {
      require(['../views/EvaluationEnter.vue'], resolve)
    }
  },
  {
    name: 'evaluationloading',
    path: '/evaluationloading',
    meta: {
      title: '智能测评'
    },
    component: (resolve) => {
      require(['../views/EvaluationLoading.vue'], resolve)
    }
  },
  {
    name: 'evaluationlist',
    ...
    component: (resolve) => {
      require(['../views/EvaluationList.vue'], resolve)
    }
  },
  {
    path: '/card',
